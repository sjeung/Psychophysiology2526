...
in the walking session, participants were instructed to walk on a straight line of 12 m in an indoor lab space, holding a smartphone in one hand. The button press was registered by touching the phone screen. At both ends of the straight segment were traffic cones. When reaching a traffic cone, they were instructred to stop, turn around the cone, and position themselves on a straight line again facing the other end before walking again. They were instructed to walk with their regular walking speed that feels natural to them.
EEG data was transmitted via bluetooth to the recording PC and interfaced with the LabstreamingLayer (Kothe et al. 2025) to be synchronized with the event stream from the smartphone, transmitted via WiFi. 
...
- Software : "Presentation", Neurobehavioural Systems
